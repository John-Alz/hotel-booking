...
export const HeaderAdmin = () => {
    ...
    return (
        <header className='bg-white w-full flex justify-between p-2 border-b'>
            ...
            <div className='flex items-center gap-3 mr-3'>
                <Bell className='mr-3' />
                <p className='border bg-black border-black py-2.5 px-4 rounded-full text-white '>{profile?.name.slice(0, 1)}</p>
                <div>
                    <div className='flex'>
