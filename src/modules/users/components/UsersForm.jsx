            ...
            <fieldset className='flex gap-10 justify-between border-t pt-4'>
                ...
                <div className='w-full flex justify-between gap-10'>
                    <div className='w-full flex flex-col gap-1' >
                        <label>Nombre *</label>
                        <input type='text' name='name' placeholder='Escribe el nombre del usuario' className='border-2 border-border py-2 px-3 rounded-3xl'
                            {...register('name')}
                        />
                    </div>
                    <div className='w-full flex flex-col gap-1' >
                        <label>Apellido *</label>
                        <input type='text' name='lastName' placeholder='Escribe el apellido del usuario' className='border-2 border-border py-2 px-3 rounded-3xl'
                            {...register('lastName')}
                        />
                    </div>
                </div>
            ...
            <fieldset className='w-full flex gap-10 justify-between border-t pt-4'>
                ...
                <div className='w-full flex justify-between gap-10'>
                    <div className='w-full flex flex-col gap-1' >
                        ...
                        <input type='text' name='phoneNumber' placeholder='Escribe el telefono del usuario' className='border-2 border-border py-2 px-3 rounded-3xl'
                            {...register('phoneNumber')}
                        />
                    </div>
                    <div className='w-full flex flex-col gap-1' >
                        <label>Email *</label>
                        <input type='text' name='email' placeholder='Escribe el email del usuario' className='border-2 border-border py-2 px-3 rounded-3xl'
                            {...register('email')}
                        />
                    </div>
                </div>
